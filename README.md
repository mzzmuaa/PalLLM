...
![Tests](https://img.shields.io/badge/tests-1321%20passing-success.svg)
...
`http://localhost:5088`. 1321 NUnit tests pass. 16/16 drift gates
...
> `1321` tests passing. `57` `/api` routes + complete `MCP` server at `/mcp`
...
dotnet test  D:\Coding\PalLLM\PalLLM.sln      # 1321 passing
...
Passed!  - Failed: 0, Passed: 1321, Skipped: 0, Total: 1321
```
