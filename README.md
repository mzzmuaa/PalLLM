...
![Tests](https://img.shields.io/badge/tests-1309%20passing-success.svg)
...
`http://localhost:5088`. 1309 NUnit tests pass. 16/16 drift gates
...
> `1309` tests passing. `57` `/api` routes + complete `MCP` server at `/mcp`
...
dotnet test  D:\Coding\PalLLM\PalLLM.sln      # 1309 passing
...
Passed!  - Failed: 0, Passed: 1309, Skipped: 0, Total: 1309
```
