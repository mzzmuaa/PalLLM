...
![Tests](https://img.shields.io/badge/tests-1306%20passing-success.svg)
...
`http://localhost:5088`. 1306 NUnit tests pass. 16/16 drift gates
...
> `1306` tests passing. `57` `/api` routes + complete `MCP` server at `/mcp`
...
dotnet test  D:\Coding\PalLLM\PalLLM.sln      # 1306 passing
...
Passed!  - Failed: 0, Passed: 1306, Skipped: 0, Total: 1306
```
