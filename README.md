...
![Tests](https://img.shields.io/badge/tests-1330%20passing-success.svg)
...
`http://localhost:5088`. 1330 NUnit tests pass. 16/16 drift gates
...
> `1330` tests passing. `57` `/api` routes + complete `MCP` server at `/mcp`
...
dotnet test  D:\Coding\PalLLM\PalLLM.sln      # 1330 passing
...
Passed!  - Failed: 0, Passed: 1330, Skipped: 0, Total: 1330
```
