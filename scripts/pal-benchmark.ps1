...
if ($errors -gt 0) {
    ...
    $bottleneck = 'fully on deterministic fallback - no live inference wired (run `pal connect llamacpp` for the local engine, or `pal connect cloud` for the OpenAI-compatible escape path)'
